    ...
    I2C: Write<Error = E> + WriteRead<Error = E>,
{
    ...
    pub fn init(
        ...
        self.write_u8(registers::CTRL_REG1, oversampling_ratio | constants::ACTIVE)?;
    ...
    pub fn read_pa_temperature(&mut self) -> Result<(f32, f32), Error<E>> {
        // (PA, T)
        ...
        if self.is_temperature_data_available(status) && self.is_pa_data_available(status) {
    ...
    fn write_u8(&mut self, reg: u8, value: u8) -> Result<(), Error<E>> {
        self.i2c
            .write(constants::ADDRESS, &[reg, value])
            .map_err(|e| Error::I2c(e))?;
    ...
    fn read_u8(&mut self, register: u8) -> Result<u8, Error<E>> {
        ...
        self.i2c
            .write_read(constants::ADDRESS, &[register], &mut buffer)
            .map_err(|e| Error::I2c(e))?;
